...
The Liaison is a deterministic prompt engine that generates platform-optimized professional messages. It treats "Professional Message" as a mathematical composition of context, applying platform-specific formatting rules and social "secret sauce" to help you get better AI outputs.
