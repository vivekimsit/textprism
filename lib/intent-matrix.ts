    ...
    fields: [
      {
        ...
        label: 'New Features',
        type: 'textarea',
        placeholder: 'What new features are shipping? (e.g., "New dashboard analytics, PDF export")',
      },
      {
        name: 'blockers',
        label: 'Blockers',
        type: 'textarea',
        placeholder: 'Any blockers or known issues? (e.g., "Waiting on API keys from DevOps")',
      },
      {
        name: 'eta',
        label: 'ETA',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'textarea',
        placeholder: 'e.g., "Blocks deployment tomorrow morning" or "Hotfix for production bug"',
      },
    ],
  },
  // WORK TIER - EMAIL
    ...
    fields: [
      {
        ...
        type: 'textarea',
        placeholder: 'What have you delivered? (e.g., "Led migration to microservices, reduced costs 40%")',
      },
      {
        name: 'market_rate',
        label: 'Market Rate Research',
        type: 'input',
        placeholder: 'What does the market pay for your role? (e.g., "$180k-220k for Senior SWE in SF")',
      },
      {
    ...
    fields: [
      {
        ...
        label: 'The Mistake',
        type: 'textarea',
        placeholder: 'What went wrong? (e.g., "Deployed to prod on Friday at 5pm, broke checkout for 2 hours")',
      },
      {
        name: 'the_learning',
        label: 'The Learning',
        type: 'textarea',
        placeholder: 'What did you learn? (e.g., "Now we have automated rollback + staging mirror")',
      },
      {
        name: 'the_result',
        label: 'The Result',
        type: 'input',
        placeholder: 'What changed? (e.g., "Zero production incidents in 6 months")',
      },
    ],
  },
  // GROWTH TIER - REDDIT
    ...
    fields: [
      {
        ...
        label: 'What I Built',
        type: 'textarea',
        placeholder: 'Describe your project (e.g., "CLI tool that auto-generates API docs from comments")',
      },
      {
        name: 'why_i_built_it',
        label: 'Why I Built It',
        type: 'textarea',
        placeholder: 'Your motivation (e.g., "Tired of our docs being out of sync with code")',
      },
      {
        name: 'tech_stack',
        label: 'Tech Stack',
    ...
    fields: [
      {
        ...
        label: 'The Question',
        type: 'input',
        placeholder: 'What question are you answering? (e.g., "How do you scale to 1M users?")',
      },
      {
        name: 'your_experience',
        label: 'Your Experience',
        type: 'textarea',
        placeholder: 'What have you done? (e.g., "Scaled 3 startups from 100k to 5M users")',
      },
      {
        name: 'key_insight',
        label: 'Key Insight',
        type: 'textarea',
        placeholder: 'What\'s the non-obvious truth? (e.g., "Database sharding is the last thing you should do")',
      },
    ],
  },
];
